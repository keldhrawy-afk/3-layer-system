...
export const SignalsTab: React.FC<SignalsTabProps> = ({ payload, auditResult }) => {
  ...
  const metaMetricGroups = [
    ...
    { title: 'Platform Purchase CVR — Layer 1', items: [['Platform Purchases', String(metrics.platform_purchases ?? 0)], ['Platform Purchase CVR', String(metrics.platform_purchase_cvr ?? '0%')], ['المعادلة', 'Platform Purchases ÷ Clicks']] },
